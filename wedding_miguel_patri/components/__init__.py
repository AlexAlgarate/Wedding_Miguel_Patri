from wedding_miguel_patri.components.card import card
from wedding_miguel_patri.components.farewall_text import farewell_message
from wedding_miguel_patri.components.flowers import (
